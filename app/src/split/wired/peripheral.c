...
#error "Need to assign a 'zmk,split-uart` node or create a wired split node with details"
...
#elif IS_ENABLED(CONFIG_ZMK_SPLIT_WIRED_UART_MODE_DEFAULT_POLLING)
...
#elif IS_ENABLED(CONFIG_ZMK_SPLIT_WIRED_UART_MODE_DEFAULT_ASYNC)
